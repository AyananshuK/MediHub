...
• Implemented secure JWT token-based authentication, role-based authorization.
• Designed RESTful APIs for secure CRUD operations.
• Included a feedback and rating system for patients. 
• Adapts seamlessly to different screen sizes for a consistent user experience.
