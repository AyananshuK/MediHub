...
import DoctorAbout from '../../pages/doctors/doctor-about'
              ...
              <div className='lg:col-span-2'>
                {data.isApproved === 'pending' && (
                  <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                    <svg aria-hidden="true" fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' className='flex-shrink-0 w-5 h-5'>
